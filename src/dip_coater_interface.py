...
entry7 = tb.Entry(manual_frame, font = ("Helvetica", 14), bootstyle = "secondary", width = 10)
entry7.grid(row = 1, column = 0, padx = (0, 5), pady = 10, sticky = "e")
unit_label7 = tb.Label(manual_frame, text = "cm/s", font = ("Helvetica", 14), bootstyle = "dark")
unit_label7.grid(row = 1, column = 1, sticky = "w", padx = (0, 60))

# Create the first lock/unlock button
lock_unlock_button1 = tb.Button(manual_frame, text = "Lock Speed", bootstyle = "success", width = 25, command = lambda: manual_lock_unlock("UP"))
...
entry8 = tb.Entry(manual_frame, font = ("Helvetica", 14), bootstyle = "secondary", width = 10)
entry8.grid(row = 5, column = 0, padx = (0, 5), pady = 10, sticky = "e")
unit_label8 = tb.Label(manual_frame, text = "cm/s", font = ("Helvetica", 14), bootstyle = "dark")
unit_label8.grid(row = 5, column = 1, sticky = "w", padx = (0, 60))

# Create the second lock/unlock button
lock_unlock_button2 = tb.Button(manual_frame, text = "Lock Speed", bootstyle = "success", width = 25, command = lambda: manual_lock_unlock("DOWN"))
...
run_list = ScrolledFrame(history_frame, bootstyle = "light", width = 327, height = 506)
run_list.grid(row = 1, column = 0, columnspan = 2, padx = 25, pady = 15)

# Create an edit button
delete_button = tb.Button(history_frame, text = "Delete", bootstyle = "danger", width = 15, command = delete_run, state = "disabled")
delete_button.grid(row = 0, column = 0, padx = 15, pady = (20, 5))

# Create a delete button
lock_unlock_button3 = tb.Button(history_frame, text = "Lock Parameters", bootstyle = "success", width = 15, command = favorite_lock_unlock, state = "disabled")
