...
substrate_label.grid(row = 1, column = 0, columnspan = 2, padx = (15, 0), pady = (12, 5), sticky = "w")
substrate_entry = tb.Entry(new_run_frame, font = ("Helvetica", 12), bootstyle = "secondary", width = 10)
substrate_entry.grid(row = 1, column = 2, padx = (0, 5), pady = 10, sticky = "e")
substrate_units = tb.Label(new_run_frame, text = "mm", font = ("Helvetica", 12), bootstyle = "dark")
substrate_units.grid(row = 1, column = 3, sticky = "w")
...
solution_label.grid(row = 2, column = 0, columnspan = 2, padx = (15, 0), pady = (12, 5), sticky = "w")
solution_entry = tb.Entry(new_run_frame, font = ("Helvetica", 12), bootstyle = "secondary", width = 10)
solution_entry.grid(row = 2, column = 2, padx = (0, 5), pady = 10, sticky = "e")
solution_units = tb.Label(new_run_frame, text = "mm", font = ("Helvetica", 12), bootstyle = "dark")
solution_units.grid(row = 2, column = 3, sticky = "w")
...
depth_label.grid(row = 3, column = 0, padx = (15, 0), pady = (12, 5), sticky = "w")
depth_entry = tb.Entry(new_run_frame, font = ("Helvetica", 12), bootstyle = "secondary", width = 10)
depth_entry.grid(row = 3, column = 2, padx = (0, 5), pady = 10, sticky = "e")
depth_units = tb.Label(new_run_frame, text = "mm", font = ("Helvetica", 12), bootstyle = "dark")
depth_units.grid(row = 3, column = 3, sticky = "w")
...
depth_toggle.grid(row = 4, column = 0, columnspan = 3, padx = 15, pady = (12, 5), sticky = "w")
...
immersion_label.grid(row = 5, column = 0, columnspan = 2, padx = (15, 0), pady = (12, 5), sticky = "w")
immersion_entry = tb.Entry(new_run_frame, font = ("Helvetica", 12), bootstyle = "secondary", width = 10)
immersion_entry.grid(row = 5, column = 2, padx = (0, 5), pady = 10, sticky = "e")
immersion_units = tb.Label(new_run_frame, text = "mm/s", font = ("Helvetica", 12), bootstyle = "dark")
immersion_units.grid(row = 5, column = 3, sticky = "w")
...
immersion_toggle.grid(row = 6, column = 0, columnspan = 3, padx = 15, pady = (12, 5), sticky = "w")
...
withdrawal_label.grid(row = 7, column = 0, columnspan = 2, padx = (15, 0), pady = (12, 5), sticky = "w")
withdrawal_entry = tb.Entry(new_run_frame, font = ("Helvetica", 12), bootstyle = "secondary", width = 10)
withdrawal_entry.grid(row = 7, column = 2, padx = (0, 5), pady = 10, sticky = "e")
withdrawal_units = tb.Label(new_run_frame, text = "mm/s", font = ("Helvetica", 12), bootstyle = "dark")
withdrawal_units.grid(row = 7, column = 3, sticky = "w")
...
submersion_label.grid(row = 8, column = 0, columnspan = 2, padx = (15, 0), pady = (12, 5), sticky = "w")
submersion_entry = tb.Entry(new_run_frame, font = ("Helvetica", 12), bootstyle = "secondary", width = 10)
submersion_entry.grid(row = 8, column = 2, padx = (0, 5), pady = 10, sticky = "e")
submersion_units = tb.Label(new_run_frame, text = "s", font = ("Helvetica", 12), bootstyle = "dark")
submersion_units.grid(row = 8, column = 3, sticky = "w")
...
lock_unlock_button.grid(row = 10, column = 1, columnspan = 3, padx = (15, 0), pady = (12, 15), sticky = "w")
