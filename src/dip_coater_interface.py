...
substrate_label.grid(row = 1, column = 0, columnspan = 2, padx = (15, 0), pady = (17, 5), sticky = "w")
...
solution_label.grid(row = 2, column = 0, columnspan = 2, padx = (15, 0), pady = (17, 5), sticky = "w")
...
depth_label.grid(row = 3, column = 0, padx = (15, 0), pady = (17, 5), sticky = "w")
...
depth_toggle.grid(row = 4, column = 0, columnspan = 3, padx = 15, pady = (5, 10), sticky = "w")
...
immersion_label.grid(row = 5, column = 0, columnspan = 2, padx = (15, 0), pady = (17, 5), sticky = "w")
immersion_entry = tb.Entry(new_run_frame, font = ("Helvetica", 12), bootstyle = "secondary", width = 10)
immersion_entry.grid(row = 5, column = 2, padx = (0, 5), pady = (17, 5), sticky = "e")
...
immersion_toggle.grid(row = 6, column = 0, columnspan = 3, padx = 15, pady = (5, 10), sticky = "w")
...
withdrawal_label.grid(row = 7, column = 0, columnspan = 2, padx = (15, 0), pady = (17, 5), sticky = "w")
withdrawal_entry = tb.Entry(new_run_frame, font = ("Helvetica", 12), bootstyle = "secondary", width = 10)
withdrawal_entry.grid(row = 7, column = 2, padx = (0, 5), pady = (17, 5), sticky = "e")
...
submersion_label.grid(row = 8, column = 0, columnspan = 2, padx = (15, 0), pady = (17, 5), sticky = "w")
...
dips_label.grid(row = 9, column = 0, padx = (15, 0), pady = (17, 5), sticky = "w")
