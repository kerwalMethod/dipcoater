...
substrate_label.grid(row = 1, column = 0, columnspan = 2, padx = (15, 0), pady = (10, 5), sticky = "w")
...
substrate_units.grid(row = 1, column = 3, sticky = "w", padx = (0, 15))
...
solution_label.grid(row = 2, column = 0, columnspan = 2, padx = (15, 0), pady = (10, 5), sticky = "w")
...
solution_units.grid(row = 2, column = 3, sticky = "w", padx = (0, 15))
...
depth_units.grid(row = 3, column = 3, sticky = "w", padx = (0, 15))
...
immersion_label.grid(row = 5, column = 0, columnspan = 2, padx = (15, 0), pady = (10, 5), sticky = "w")
...
immersion_units.grid(row = 5, column = 3, sticky = "w", padx = (0, 15))
...
withdrawal_label.grid(row = 7, column = 0, columnspan = 2, padx = (15, 0), pady = (10, 5), sticky = "w")
...
withdrawal_units.grid(row = 7, column = 3, sticky = "w", padx = (0, 15))
...
submersion_label.grid(row = 8, column = 0, columnspan = 2, padx = (15, 0), pady = (10, 5), sticky = "w")
...
submersion_units.grid(row = 8, column = 3, sticky = "w", padx = (0, 15))
...
dips_units.grid(row = 9, column = 3, sticky = "w", padx = (0, 15))
...
lock_unlock_button.grid(row = 10, column = 1, columnspan = 3, padx = (0, 15), pady = (10, 15), sticky = "w")
