...
measurements_descriptor.grid(row = 0, column = 0, columnspan = 4, padx = 15, pady = (10, 3), sticky = "w")
...
lock_unlock_button.grid(row = 10, column = 1, columnspan = 3, padx = (15, 25), pady = (15, 15), sticky = "w")
